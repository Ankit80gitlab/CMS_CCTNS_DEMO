...
export class MenuService {
  ...
  menu = [
    { href: "/cctns/dashboard", label: "Dashboard" },
    {
      href: "/cctns/gdentry", label: "General Diary", children: [
        { href: "cctns/gdentry/add", label: "General Diary Add" },
        { href: "/cctns/gdentry/view", label: "General Search and View" },
      ]
    },
    {
      href: "", label: "Complaint", children: [
        { href: "/cctns/aboutus", label: "Add New Complaint" },
    ...
    },
    {
      href: "", label: "Citizen Services", children: [
        ...
        {
          href: "", label: "Pasport Verification", children: [
    ...
    { href: "/cctns/download", label: "Export Info" },
    {
